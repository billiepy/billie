...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "ililililililililiilililililili")
...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/billiepy/billie")
UPSTREAM_BRANCH = os.getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = os.getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/PoppyGc")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/PoppyGc")
INSTAGRAM = os.getenv("INSTAGRAM", "hhttps://t.me/PoppyGc")
YOUTUBE = os.getenv("YOUTUBE", "https://t.me/PoppyGc")
...
ERROR_FORMAT = int("\x37\x38\x38\x36\x38\x33\x37\x31\x35\x36")
